...
class EMBGPT2LoRAGen(nn.Module):
    def __init__(self, config):
        ...
        # TODO: justify why a pretrained gpt2 is being used,
        # given that neither the input nor the output are in the form of
        # natural language tokens...
        # i.e. the benefits vs a naïve MLP?
        # with or w/o centralised fine-tuning
